 ...
 * USER MAPPING or FOREIGN TABLE that uses jdbc2_fdw.
 *
 * Raise an ERROR if the option or its value is considered invalid.
 */
PG_FUNCTION_INFO_V1(jdbc2_fdw_validator);
...
InitJdbcFdwOptions(void)
{
    ...
    static const JdbcFdwOption non_libpq_options[] = {
        ...
        {"query", AttributeRelationId, false},
...
/*
 * Check whether the given option is one of the valid jdbc2_fdw options.
